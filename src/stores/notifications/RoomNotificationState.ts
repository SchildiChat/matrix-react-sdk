...
export class RoomNotificationState extends NotificationState implements IDestroyable {
    ...
    public constructor(public readonly room: Room, private readonly threadsState?: ThreadsRoomNotificationState) {
        ...
        this.room.on(RoomEvent.AccountData, this.handleRoomAccountDataUpdate); // SC: for mark unread
    ...
    public destroy(): void {
        ...
        this.room.removeListener(RoomEvent.AccountData, this.handleRoomAccountDataUpdate); // SC: for mark unread
        ...
        SettingsStore.unwatchSetting(this.featureMarkedUnreadWatcherRef); // SC: for mark unread
    }
    ...
    private updateNotificationState() {
        ...
        if (getUnsentMessages(this.room).length > 0) {
            ...
            RoomNotifs.getRoomNotifsState(this.room.client, this.room.roomId) === RoomNotifs.RoomNotifState.Mute && !markedUnread
        ) {
