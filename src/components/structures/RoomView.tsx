...
export class RoomView extends React.Component<IRoomProps, IRoomState> {
    ...
    public constructor(props: IRoomProps, context: React.ContextType<typeof SDKContext>) {
        ...
        context.client.on(ClientEvent.AccountData, this.onAccountData);
    ...
    public componentWillUnmount(): void {
        ...
        if (this.context) {
            ...
            this.context.client.removeListener(ClientEvent.AccountData, this.onAccountData);
    ...
    private recalculateUserNameColorMode = (): void => {
